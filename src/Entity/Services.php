...
class Services
{
    ...
    public function getImageServiceAlt(): ?string
    {
        return $this->image_service_alt;
    }

    public function setImageServiceAlt(string $image_service_alt): self
    {
        $this->image_service_alt = $image_service_alt;
